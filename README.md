...
[![CurseForge Project](https://img.shields.io/badge/CurseForge-Project-orange.svg)](https://www.curseforge.com/wow/addons/equip-optimizer)
[![WoW Addon Version](https://img.shields.io/badge/WoW-12.0.5-blue.svg)](https://warcraft.wiki.gg/wiki/World_of_Warcraft_API)
...
Your specialization feels great once you hit **30% Haste**, but stacking any more than that is a waste of stats.
*   **Without the Addon:** You spend 10 minutes dragging rings and necklaces on and off, trying to get as close to 30% as possible without going over.
*   **With EquipOptimizer:** You set Haste >= 30% as Rule 1, and Critical Strike as Rule 2. The addon scans your bags, hits exactly 30% Haste, and fills every remaining stat budget with Crit.
...
Вашему персонажу для идеальной ротации нужно **30% Скорости**, а собирать больше — пустая трата характеристик.
*   **Без аддона:** Вы тратите 10 минут, примеряя разные кольца и ожерелья, пытаясь подойти как можно ближе к 30% и не перебрать лишнего.
*   **С EquipOptimizer:** Вы создаете правило «Скорость >= 30%», а вторым правилом ставите «Критический удар». Аддон подбирает вещи так, чтобы получить ровно 30% скорости, а все остальные ресурсы экипировки направляет в Крит.
